package com.example.firebase_room.adapter
...
import com.example.firebase_room.databinding.CategoryItemLayoutBinding
...
class CategoryViewHolder(itemView: View, val onTap: (Category) -> Unit) :
